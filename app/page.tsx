...
return ( <main className="min-h-screen bg-gray-50"> <section className="bg-blue-900 text-white py-16 text-center"> <h1 className="text-5xl font-bold">
Lakshya Current Affairs & PCS Academy </h1>

```
    <p className="mt-4 text-xl">
      UPPSC PCS • PET • Lekhpal • Health Education Officer • RO/ARO
    </p>
  </section>
